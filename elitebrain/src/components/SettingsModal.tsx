      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-[#5C6CF2]" />
        ...
        <div className="space-y-4 text-xs">
          ...
          <div className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <UserIcon className="w-4 h-4 text-[#5C6CF2]" />
            ...
            <form onSubmit={handleSaveName} className="flex items-center gap-2">
              <input
                ...
                maxLength={30}
                className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-2 text-slate-100 text-xs focus:outline-none focus:border-[#5C6CF2]"
              />
              <button
                type="submit"
                disabled={isSavingName || !nameInput.trim()}
                className="px-3.5 py-2 bg-[#5C6CF2] hover:bg-[#4B5BE0] text-white font-mono font-bold rounded-xl text-xs transition-all cursor-pointer disabled:opacity-50 shrink-0"
              >
          ...
          <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-950/80 border border-slate-800">
            <div className="flex items-center gap-3">
              {profile.soundEnabled ? (
                <Volume2 className="w-5 h-5 text-[#5C6CF2]" />
              ) : (
