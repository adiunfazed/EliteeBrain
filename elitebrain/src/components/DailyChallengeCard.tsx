      ...
      {completed ? (
        ...
        <>
          ...
          <motion.button
            ...
            className="mt-4 w-full py-3 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] text-white text-sm font-mono font-black flex items-center justify-center gap-2 transition-colors"
          >
