      ...
      {completed ? (
        <>
          ...
          <button
            ...
            className="mt-3 text-[11px] font-mono font-bold text-[#818CF8] hover:text-[#A5B4FC] flex items-center gap-1 transition-colors"
          >
            Try again
        ...
        <>
          ...
          <motion.button
            ...
            className="eb-lift eb-glow-indigo eb-shine mt-4 w-full py-3 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] text-white text-sm font-mono font-black flex items-center justify-center gap-2"
          >
