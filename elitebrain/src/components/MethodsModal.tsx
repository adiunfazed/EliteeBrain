        ...
        <div className="p-4 md:p-6 overflow-y-auto space-y-6 text-xs md:text-sm text-ink leading-relaxed font-sans">
          ...
          <div className="p-4 bg-surface-sunk border border-rule rounded-[2px] space-y-2">
            ...
            <p className="text-ink-muted">
              EliteBrain implements peer-reviewed cognitive paradigms designed to measure and stress specific sub-components of executive function. We state plainly what training accomplishes and what remains unproven by scientific consensus.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 pl-4 list-disc text-ink-muted">
              ...
              <li>
                <strong className="text-ink">No Clinical Medical Claims:</strong> EliteBrain is a measurement and training instrument for healthy cognitive optimization, not a medical treatment for ADHD, dementia, or neurological disease.
              </li>
            </ul>
          </div>
