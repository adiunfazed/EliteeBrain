      ...
      <div className="flex items-center justify-between gap-2 pb-2 border-b border-[#2A313C]">
        <div className="flex items-center gap-1.5 p-1 bg-[#12161F] border border-[#2A313C] rounded-2xl w-full sm:w-auto overflow-x-auto no-scrollbar">
          <button
            ...
            className={`eb-press eb-shine flex-1 sm:flex-initial px-3 sm:px-4 py-2 rounded-xl text-[10px] sm:text-xs font-mono font-bold cursor-pointer flex items-center justify-center gap-1.5 sm:gap-2 whitespace-nowrap ${
              activeSubTab === 'rank'
                ? 'bg-[#5C6CF2] text-white shadow-lg shadow-[#5C6CF2]/35'
