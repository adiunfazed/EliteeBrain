          ...
          <div className="flex items-center gap-2 mt-3 flex-wrap">
            {onStartFocus && (
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] text-white text-xs font-mono font-black flex items-center gap-1.5 transition-colors"
              >
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        {[
          ...
          <button
            ...
            className={`text-[11px] font-mono font-bold px-3 py-2 rounded-xl border transition-all flex items-center gap-1.5 ${
              tab === t.id
        ...
        <div className="text-center py-12 px-6 border border-dashed border-[#2A313C] rounded-2xl">
          ...
          {tab !== 'completed' && (
            <button
              ...
              className="mt-4 px-4 py-2.5 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] text-white text-xs font-mono font-black inline-flex items-center gap-1.5 transition-colors"
            >
