      ...
      <motion.div
        ...
        className={`group eb-shine eb-lift relative overflow-hidden rounded-2xl border ${
          task.completed
            ...
            : highlight
              ? 'bg-gradient-to-br from-[#141A28] to-[#0E1116] border-[#5C6CF2]/40 eb-glow-indigo'
                ...
                : task.category === 'fitness'
                  ...
                  : task.category === 'personal'
                    ...
                    : task.category === 'work'
                      ...
                      : 'bg-gradient-to-br from-[#111623] to-[#0E1116] border-[#2A313C] hover:border-[#5C6CF2]/40 eb-glow-indigo'
        }`}
      >
        {!task.completed && (
          <span
