            ...
            <div className="flex items-center gap-1.5 mt-2.5 flex-wrap">
              ...
              {habit.metric === 'duration' && onStartFocus && (
                <button
                  ...
                  className="text-[10px] font-mono font-bold px-3 py-2 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 hover:bg-emerald-500/20 flex items-center gap-1.5"
                >
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        {(['today', 'goals', 'habits'] as Pane[]).map((p) => (
          <button
            ...
            className={`text-[11px] font-mono font-bold px-3 py-2 rounded-xl border capitalize transition-all ${
              pane === p
            ...
            {todaysHabits.length === 0 ? (
              <div className="text-center py-10 px-6 border border-dashed border-[#2A313C] rounded-2xl">
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2.5 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] text-white text-xs font-mono font-black inline-flex items-center gap-1.5"
                >
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Add goal"
              className="shrink-0 w-11 h-11 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] disabled:opacity-40 text-white flex items-center justify-center"
            >
