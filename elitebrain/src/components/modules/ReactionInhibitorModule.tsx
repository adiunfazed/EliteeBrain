    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-950 text-slate-100 overflow-y-auto">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 max-w-xl mx-auto w-full">
        ...
        {phase === 'waiting' && (
          ...
          >
            <div className="w-16 h-16 rounded-full bg-rose-950/40 border border-rose-300 flex items-center justify-center mb-4 animate-pulse">
        ...
        {phase === 'ready' && (
          ...
          >
            <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center mb-4 animate-ping">
              <Zap className="w-10 h-10 text-emerald-600 fill-current" />
            </div>
