...
export const FocusSection: React.FC<Props> = ({ userId }) => {
  ...
  if (active) {
    ...
    return (
      ...
      >
        ...
        <div
          className={`mt-6 font-mono font-black tabular-nums tracking-tight transition-colors text-5xl sm:text-7xl ${
        ...
        <div className="mt-6 h-1.5 w-full max-w-md mx-auto bg-[#171B22] rounded-full overflow-hidden">
          <motion.div
        ...
        <div className="mt-7 flex items-center justify-center gap-2.5 flex-wrap">
          ...
          <motion.button
            ...
            className="px-5 py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 text-xs font-mono font-black flex items-center gap-2 transition-colors"
          >
    ...
    <div className="space-y-4">
      ...
      <div className="bg-[#0E1116] border border-[#2A313C] rounded-2xl p-4 space-y-4">
        ...
        <motion.button
          ...
          className="w-full py-3.5 rounded-xl bg-[#5C6CF2] hover:bg-[#4F5BE0] disabled:opacity-40 disabled:cursor-not-allowed text-white text-sm font-mono font-black flex items-center justify-center gap-2 transition-colors"
        >
