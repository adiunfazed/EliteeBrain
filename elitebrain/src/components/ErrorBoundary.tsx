...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error('Uncaught error caught by EliteBrain ErrorBoundary:', error, errorInfo);
          ...
          <div className="max-w-md w-full bg-[#12161F] border border-[#2A313C] rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6 text-center relative overflow-hidden">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-[#98A2B3] leading-relaxed">
                EliteBrain encountered an unexpected UI state exception. Don't worry, your data is protected.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 pt-2">
              <button
                ...
                className="w-full h-11 bg-[#5C6CF2] hover:bg-[#4B5ACD] text-white font-mono text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95 cursor-pointer"
              >
              ...
              <button
                ...
                className="w-full h-11 bg-[#171B22] hover:bg-[#1E232D] border border-[#2A313C] text-[#A5B4FC] font-mono text-xs font-semibold rounded-xl flex items-center justify-center gap-2 transition-all active:scale-95 cursor-pointer"
              >
            ...
            <p className="text-[10px] text-[#667085] font-mono">
              EliteBrain Cognitive Performance Suite v2.0
            </p>
          </div>
        </div>
      );
