...
export type DashboardSection = 'engine' | 'exercises' | 'coach' | 'games' | 'community';
...
export const Dashboard: React.FC<Props> = ({
  ...
  return (
    <div className="space-y-6 pb-28 font-sans select-none relative min-h-[80vh]">
      ...
      <AnimatePresence mode="wait">
        ...
        {activeSection === 'community' && (
          <motion.div
            ...
            transition={{ duration: 0.25 }}
          >
            <CommunitySection userBrainScore={brainScore} />
          </motion.div>
        )}
      ...
      <div className="fixed bottom-0 inset-x-0 z-40 bg-[#0D1117]/95 backdrop-blur-2xl border-t border-[#2A313C] px-2 py-1 shadow-2xl">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative py-1 px-1 rounded-lg flex flex-col items-center justify-center gap-0.5 transition-all cursor-pointer ${
                  isActive
