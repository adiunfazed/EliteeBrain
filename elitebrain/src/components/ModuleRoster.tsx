        ...
        {MODULE_METADATA.map((meta, index) => {
          ...
          return (
            <motion.div
              ...
              className="group relative flex flex-col md:grid md:grid-cols-12 items-stretch min-h-[64px] px-4 py-3 md:py-0 bg-surface hover:bg-surface-sunk active:bg-[#5C6CF2]/10 active:scale-[0.98] transition-all duration-120 cursor-pointer select-none touch-manipulation"
            >
