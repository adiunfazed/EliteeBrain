    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#0E1116] overflow-y-auto font-sans select-none animate-fadeIn">
      ...
      <div className="relative w-full max-w-lg bg-[#171B22] border border-[#2A313C] rounded-3xl p-6 sm:p-10 shadow-2xl my-auto text-center">
        ...
        <div className="flex flex-col items-center mb-6">
          <EliteBrainLogo size="lg" showSubtext={false} />
          
          <div className="mt-3 flex items-center justify-center">
            <h1 className="text-2xl font-black font-mono text-[#F4F6F8] tracking-wider">
              ELITE<span className="text-[#5C6CF2]">BRAIN</span>
            </h1>
          </div>
          <p className="text-xs text-[#98A2B3] mt-1 max-w-sm">
            Cognitive Performance Suite. Sign in to save progress across all devices.
          </p>
        </div>
        ...
        <div className="flex rounded-2xl bg-[#0E1116] p-1 border border-[#2A313C] mb-6 shadow-inner">
          <button
            ...
            className={`flex-1 py-2.5 text-xs font-bold rounded-xl transition-all cursor-pointer ${
              authMethod === 'google'
                ? 'bg-[#5C6CF2] text-white shadow-sm'
        ...
        {authMethod === 'google' ? (
          <div>
            ...
            <div className="bg-[#0E1116] rounded-2xl border border-[#2A313C] p-4 mb-6 text-left space-y-2.5">
              ...
              <div className="flex items-center gap-2.5 text-xs text-[#F4F6F8] font-medium">
                <ShieldCheck className="w-4 h-4 text-[#5C6CF2] shrink-0" />
            ...
            >
              {loading ? (
                <>
                  <Loader2 className="w-5 h-5 text-[#5C6CF2] animate-spin" />
            ...
            <button
              ...
              className="w-full text-center text-xs font-semibold text-[#5C6CF2] hover:underline py-2 cursor-pointer underline-offset-4 mt-2"
            >
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4 text-left mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0E1116] border border-[#2A313C] focus:border-[#5C6CF2] rounded-xl pl-10 pr-4 py-3 text-xs text-[#F4F6F8] placeholder-[#98A2B3]/50 focus:outline-none transition-colors"
                  />
                </div>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-[#5C6CF2] hover:bg-[#5C6CF2]/90 text-white font-bold text-xs uppercase tracking-wider cursor-pointer shadow-lg transition-all active:scale-95 disabled:opacity-50 mt-2"
            >
              {loading ? (
                <>
        ...
        >
          ...
          <ArrowRight className="w-4 h-4 text-[#5C6CF2]" />
        </button>
