...
5. NEVER repeat static boilerplate text or canned templates when the user asks a specific question.`;
  ...
  if (mode === 'audit') {
    prompt = `Generate my comprehensive Elite Brain Cognitive Audit. Analyze my current module levels and daily streak, identify where I'm doing well and where I'm weakest, and suggest 3 concrete daily habits.`;
  }
