  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-fadeIn overflow-y-auto">
      <div className="relative w-full max-w-md bg-[#171B22] border border-[#2A313C] rounded-3xl p-6 md:p-8 shadow-2xl my-auto text-center">
        ...
        {/* Icon Header */}
        <div className="w-14 h-14 mx-auto mb-3 rounded-2xl bg-[#5C6CF2]/15 border border-[#5C6CF2]/30 flex items-center justify-center text-[#5C6CF2] shadow-lg">
          <Cloud className="w-7 h-7" />
        </div>

        <h2 className="text-xl md:text-2xl font-black text-[#F4F6F8] mb-1">
          {emailMode === 'reset' ? 'Reset Account Password' : 'Sign In to EliteBrain'}
        </h2>
        ...
        {authMethod === 'google' ? (
          <div>
            ...
            <button
              ...
              className="w-full text-center text-xs font-semibold text-[#5C6CF2] hover:underline py-1.5 cursor-pointer underline-offset-4 mb-2"
            >
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-3.5 text-left mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[#0E1116] border border-[#2A313C] focus:border-[#5C6CF2] rounded-xl pl-10 pr-4 py-2.5 text-xs text-[#F4F6F8] placeholder-[#98A2B3]/50 focus:outline-none transition-colors"
                  />
                </div>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#5C6CF2] hover:bg-[#5C6CF2]/90 text-white font-bold text-xs uppercase tracking-wider cursor-pointer shadow-lg transition-all active:scale-95 disabled:opacity-50 mt-2"
            >
              {loading ? (
                <>
