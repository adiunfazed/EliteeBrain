...
export const PLANS: Plan[] = [
  {
    ...
    days: 30,
    cadence: 'per month',
    blurb: 'Everything unlocked. Stop any time by simply not renewing.',
    perMonth: 249,
  },
  {
    id: 'yearly',
    ...
    days: 365,
    cadence: 'per year',
    blurb: 'The same thing, paid once a year instead of twelve times.',
    perMonth: Math.round(1999 / 12),
    badge: 'Most popular',
  },
  {
    id: 'lifetime',
    ...
    days: null,
    cadence: 'one time',
    blurb: 'Pay once. Everything now and everything added later, permanently.',
    perMonth: null,
  },
];
