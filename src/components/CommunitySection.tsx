        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5 relative z-10">
          <div className="space-y-2 max-w-2xl">
            <div className="flex flex-wrap items-center gap-2">
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-sky-500/15 border border-sky-500/30 text-sky-400 t-meta rounded-full uppercase tracking-wider">
                <Send className="w-3.5 h-3.5 shrink-0" />
                Telegram Community
              </span>
              <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 bg-red-500/15 border border-red-500/30 text-red-400 t-meta rounded-full uppercase tracking-wider">
        ...
        <div className="bg-[var(--surface)] border border-sky-500/40 rounded-xl p-5 sm:p-7 relative overflow-hidden shadow-none space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
            <div className="flex items-center gap-3.5 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="t-meta uppercase tracking-wider text-sky-400 px-2 py-0.5 bg-sky-500/15 border border-sky-500/30 rounded-md">
                    Official Telegram Channel
                  </span>
                  <span className="t-meta eb-done font-bold flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 shrink-0 w-full sm:w-auto pt-2 sm:pt-0">
              <button
                onClick={handleOpenTg}
                className="flex-1 min-w-0 sm:flex-initial px-5 py-3 bg-sky-500 hover:bg-sky-400 text-slate-950 font-mono text-xs font-extrabold rounded-xl shadow-md shadow-sky-500/20 flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-95 whitespace-nowrap"
              >
              ...
              <button
                ...
                className="px-4 py-3 bg-[#1A1F2C] hover:bg-[#212631] border border-[var(--rule)] text-white rounded-xl cursor-pointer transition-all active:scale-95 flex items-center justify-center gap-1.5 text-xs font-mono font-bold shrink-0"
              >
                {copiedTg ? (
                  <>
                  ...
                  <>
                    <Copy className="w-3.5 h-3.5 shrink-0 text-[var(--ink-muted)]" />
                    <span>Copy</span>
                  </>
                )}
              </button>
        ...
        <div className="bg-[var(--surface)] border border-red-500/40 rounded-xl p-5 sm:p-7 relative overflow-hidden shadow-none space-y-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
            <div className="flex items-center gap-3.5 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 flex-wrap">
                  <span className="t-meta uppercase tracking-wider text-red-400 px-2 py-0.5 bg-red-500/15 border border-red-500/30 rounded-md">
                    Official YouTube Channel
                  </span>
                  <span className="t-meta text-red-400 font-bold flex items-center gap-1">
                    <span className="w-2 h-2 shrink-0 rounded-full bg-red-500 animate-ping" />
                    New Videos
                  </span>
                </div>
                <h2 className="text-lg sm:text-xl font-display font-bold text-white mt-1 truncate">
