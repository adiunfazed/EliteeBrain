      ...
      <div className="bg-[#0E1116] border border-[#2A313C] rounded-2xl p-3.5 sm:p-4">
        <div className="flex items-center gap-2">
          ...
          <motion.button
            ...
            aria-label="Add task"
            className="eb-lift eb-glow-brand eb-shine shrink-0 w-11 h-11 rounded-xl bg-[#8B5CF6] hover:bg-[#7C3AED] disabled:opacity-40 disabled:cursor-not-allowed text-white flex items-center justify-center"
          >
        ...
        <div className="text-center py-12 px-6 border border-dashed border-[#2A313C] rounded-2xl">
          ...
          {tab !== 'completed' && (
            <button
              ...
              className="eb-lift eb-glow-brand eb-shine mt-4 px-4 py-2.5 rounded-xl bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-xs font-mono font-black inline-flex items-center gap-1.5"
            >
