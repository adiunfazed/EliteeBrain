  ...
  return (
    <div className="panel">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="w-9 h-9 rounded-lg flex items-center justify-center text-[#8A93A5] hover:text-[#F2F4F7]"
          >
          ...
          <button
            ...
            className="w-9 h-9 rounded-lg flex items-center justify-center text-[#8A93A5] hover:text-[#F2F4F7] disabled:opacity-30"
          >
      ...
      <div className="flex items-center justify-end gap-1.5 mt-3">
        ...
        {[0, 25, 55, 85].map((v) => (
          <span key={v} style={shade(v)} className="w-3.5 h-3.5 rounded" />
        ))}
