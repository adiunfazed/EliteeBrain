  ...
  return (
    <div className="eb-panel p-4 sm:p-5">
      ...
      <div className="mt-3 h-1.5 w-full bg-[var(--surface-sunk)] rounded-full overflow-hidden">
        <motion.div
          className={`h-full rounded-full ${allDone ? 'bg-emerald-500' : 'bg-[var(--signal)]'}`}
          initial={false}
          ...
          return (
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                ...
                <span className="block t-meta mt-0.5">
                  {g.detail}
                </span>
              </span>
            </button>
