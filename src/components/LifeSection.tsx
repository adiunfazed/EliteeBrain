...
export const LifeSection: React.FC<Props> = ({ userId }) => {
          ...
          <div className="bg-[#0E1116] border border-[#2A313C] rounded-2xl p-3.5 space-y-2.5">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="eb-lift eb-shine shrink-0 w-11 h-11 rounded-xl bg-[#8B5CF6] hover:brightness-110 disabled:opacity-40 text-white flex items-center justify-center"
              >
