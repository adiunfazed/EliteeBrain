      ...
      <div className="relative w-full max-w-3xl bg-surface border border-rule rounded-xl p-5 sm:p-8 shadow-none overflow-hidden my-auto">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-rule mb-6">
          <div className="flex items-center gap-2.5">
            <div className="w-8 h-8 shrink-0 rounded-xl bg-signal/15 border border-signal/40 text-signal flex items-center justify-center font-bold font-mono text-xs">
              {currentStep}
            </div>
            <div>
              <span className="t-meta text-ink-muted uppercase tracking-wider block">
                Onboarding Protocol • Step {currentStep} of {totalSteps}
              </span>
              <h2 className="text-sm sm:text-base font-display font-bold text-ink">
                {currentStep === 1 && 'Welcome to Elite Life'}
              ...
              >
                <div className="text-center max-w-xl mx-auto space-y-2">
                  ...
                  <p className="text-xs sm:text-sm text-ink-muted leading-relaxed">
                    Elite Life combines clinical neuroscience paradigms into a structured, daily 5-minute training routine designed to elevate working memory span, attention control, and processing speed.
                  </p>
                </div>
                ...
                <div className="relative mx-auto w-full max-w-md bg-gradient-to-b from-surface-sunk to-surface border border-rule rounded-xl p-6 text-center overflow-hidden shadow-inner">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-20 pointer-events-none">
                    <motion.div
                      ...
                      className="w-64 h-64 shrink-0 rounded-full border-2 border-dashed border-signal"
                    />
                  </div>
            ...
            {currentStep === 2 && (
              ...
              >
                ...
                <div className="p-3 bg-surface-sunk border border-rule rounded-xl text-xs font-mono text-ink-muted flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Flame className="w-4 h-4 shrink-0 eb-warn" />
            ...
            {currentStep === 3 && (
              ...
              >
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-ink-muted">
                    Elite Life measures your response latency (in milliseconds) and accuracy rate after every trial to ensure you remain in your peak growth window.
                  </p>
                </div>
                ...
                <div className="bg-surface-sunk border border-rule rounded-xl p-4 sm:p-5 space-y-4">
                  <div className="flex items-center justify-between border-b border-rule pb-3">
                    ...
                    <span className="t-meta text-ink-muted">Try tweaking parameters below</span>
                  </div>
                    ...
                    return (
                      <div className={`p-4 rounded-xl border transition-all ${levelColor}`}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="t-meta">Real-time Feedback</span>
                        </div>
                    ...
                    <div className="bg-surface-sunk border border-rule rounded-xl p-4 space-y-4">
                      <div className="flex items-start justify-between gap-3 border-b border-rule pb-3">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <span className="t-meta text-ink-muted uppercase">
                              {currentPillar.badge}
                            </span>
                            <h3 className="text-base font-display font-bold text-ink">
                              {currentPillar.title}
                        ...
                        <div className="flex flex-col items-end gap-1">
                          {currentPillar.modules.map((m) => (
                            <span
                              key={m}
                              className="px-2 py-0.5 bg-surface border border-rule rounded-md t-meta text-ink"
                            >
                              {m}
                            </span>
                          ))}
                      ...
                      <div className="p-3 bg-surface border border-rule rounded-xl space-y-2">
                        <span className="t-meta uppercase text-ink-muted font-bold block">
              ...
              >
                <div>
                  <div className="inline-flex items-center gap-1 px-2.5 py-0.5 bg-emerald-500/15 border border-emerald-500/30 eb-done text-xs font-mono font-bold rounded-md mb-1">
                    <RocketIcon className="w-3.5 h-3.5 shrink-0" />
                  ...
                  <div className="p-4 bg-surface-sunk border border-rule rounded-xl space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {[
                        ...
                        >
                          <Clock className="w-4 h-4 shrink-0 mb-1" />
