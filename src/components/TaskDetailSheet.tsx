          ...
          <div className="flex items-center gap-2 pt-1 flex-wrap">
            {onStartFocus && !task.completed && (
              <button
                ...
                className="flex-1 min-w-0 min-w-[120px] py-3 rounded-xl bg-[#8B5CF6] hover:bg-[#7C3AED] text-white text-xs font-mono font-black flex items-center justify-center gap-1.5"
              >
