        ...
        <div className="relative w-20 h-20 mx-auto mb-3">
          {user.photoURL ? (
            <img
              src={user.photoURL}
              alt="Profile"
              className="w-20 h-20 rounded-full border-2 border-[#8B5CF6] shadow-lg shadow-[#8B5CF6]/20 object-cover"
            />
          ) : (
            <div className="w-20 h-20 rounded-full bg-[#8B5CF6] text-white font-black text-2xl flex items-center justify-center border-2 border-[#8B5CF6]">
        ...
        <div className="bg-slate-950/90 border border-slate-800 rounded-2xl p-3 mb-4 space-y-2 text-left">
          <div className="flex items-center justify-between text-xs font-mono text-slate-300">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <Edit2 className="w-2.5 h-2.5 text-[#8B5CF6]" />
          ...
          {isEditing ? (
            <form onSubmit={handleSaveName} className="flex items-center gap-2 pt-1">
              <input
                ...
                maxLength={30}
                className="flex-1 bg-slate-900 border border-slate-800 rounded-xl px-3 py-1.5 text-xs text-slate-100 font-mono focus:outline-none focus:border-[#8B5CF6]"
              />
              <button
                type="submit"
