...
import { X, Zap, ArrowLeft, Play, Timer, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-slate-950 text-slate-100 overflow-y-auto">
      ...
      <div className="flex items-center gap-3 p-3 md:px-8 border-b border-slate-800/80 bg-slate-900/60 backdrop-blur-lg">
        ...
        <div className="flex items-center gap-2 min-w-0 flex-1">
          ...
          <h2 className="text-[15px] font-bold text-slate-100 truncate min-w-0">Prefrontal Focus</h2>
          <span className="text-[11px] font-semibold px-2 py-0.5 rounded-full bg-violet-500/10 text-violet-400 border border-violet-500/30 shrink-0 whitespace-nowrap">
            Lvl {currentLevel}
          </span>
        </div>
