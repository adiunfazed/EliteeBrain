    ...
    <div className="eb-card relative overflow-hidden p-4 sm:p-5 space-y-4">
        ...
        >
          ...
          <div className="flex items-center gap-2 mt-3 flex-wrap">
            <button
              ...
              className="eb-btn-primary px-4 py-2.5 rounded-xl text-xs font-mono font-black flex items-center gap-1.5"
            >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        <button
          ...
          className={`eb-press text-left rounded-xl p-3.5 min-w-0 border transition-all ${
            currentBlock?.live
