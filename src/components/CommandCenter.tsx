...
interface Props {
  input: MomentumInput;
  displayName?: string;
  onOpenHub: (pane: 'tasks' | 'focus' | 'goals' | 'life') => void;
        ...
        >
          ...
          <div className="flex items-center gap-2 mt-3 flex-wrap">
            <button
              ...
              className="eb-lift eb-shine eb-glow-indigo px-4 py-2.5 rounded-xl bg-[#8B5CF6] hover:brightness-110 text-white text-xs font-mono font-black flex items-center gap-1.5"
            >
