          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1 min-w-0 sm:w-64">
              ...
              <input
                ...
                className="w-full bg-[#0E1116] border border-[#2A313C] rounded-xl pl-9 pr-3 py-2.5 text-xs text-[#F4F6F8] placeholder:text-[#98A2B3] focus:border-[#5C6CF2] focus:outline-none"
              />
            </div>
            ...
            filteredUsers.length === 0 ? (
              ...
              <div className="space-y-2.5">
                {filteredUsers.map((u) => (
                  <div
                    key={u.uid}
                    className="eb-shine eb-lift eb-glow-indigo p-3.5 rounded-2xl bg-[#0E1116] border border-[#2A313C] hover:border-[#5C6CF2]/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3"
                  >
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-[11px] font-mono text-[#5C6CF2] mt-0.5 break-all">{u.email}</div>
