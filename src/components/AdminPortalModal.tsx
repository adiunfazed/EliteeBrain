    ...
    <div className="fixed inset-0 z-[92] flex items-center justify-center p-3 md:p-6 bg-black/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-4xl bg-[var(--surface-sunk)] border border-[var(--rule)] rounded-xl p-4 sm:p-5 md:p-7 shadow-none text-left overflow-hidden h-[92dvh] sm:h-auto sm:max-h-[90vh] flex flex-col text-[var(--ink)]">
        ...
        <div className="flex gap-2 mt-4 shrink-0">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
              activeTab === 'PAYMENTS'
                ? 'bg-[var(--signal)] text-white shadow-md'
        ...
        <button
          ...
          className="eb-press md:hidden mt-4 w-full py-2.5 rounded-xl bg-[var(--ground)] border border-[var(--rule)] t-meta shrink-0"
        >
            ...
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-xs font-mono font-black eb-done truncate max-w-full max-w-[140px]">
                    {merchantUpi}
                  </span>
                </div>
              </div>
            ...
            {isEditingUpi && (
              <form onSubmit={handleSaveUpi} className="mt-3 pt-3 border-t border-[var(--rule)] flex gap-2">
                <input
                  ...
                  className="flex-1 min-w-0 bg-[var(--surface-sunk)] border border-[var(--rule)] rounded-xl px-3 py-1.5 text-xs font-mono text-[var(--ink)] focus:border-[var(--signal)] focus:outline-none"
                />
                <button
                  type="submit"
                  disabled={savingUpi}
            ...
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-xs font-mono font-black text-sky-300 truncate max-w-full max-w-[140px]">
                    {telegramLink}
                  </span>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-xs font-mono font-black text-red-300 truncate max-w-full max-w-[140px]">
                    {youtubeLink}
                  </span>
                </div>
              </div>
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1 min-w-0 sm:w-64">
              ...
              <input
                ...
                className="w-full bg-[var(--ground)] border border-[var(--rule)] rounded-xl pl-9 pr-3 py-2.5 text-xs text-[var(--ink)] placeholder:text-[var(--ink-muted)] focus:border-[var(--signal)] focus:outline-none"
              />
            </div>
                    ...
                    <div className="flex items-start gap-3 min-w-0">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span className="t-meta px-2 py-0.5 rounded-full bg-[var(--surface-sunk)] border border-[var(--rule)] text-[var(--ink-muted)] uppercase">
                            {u.authProvider}
                          </span>
                          {(() => {
                            ...
                            return (
                              <span className={`text-[11px] font-semibold px-2 py-0.5 rounded-full border flex items-center gap-1 ${tone}`}>
                                {e.status === 'lifetime' && <Crown className="w-3.5 h-3.5 shrink-0 eb-warn" />}
