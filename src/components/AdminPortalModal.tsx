          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h2 className="text-lg font-black text-[#F4F6F8] flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-[#8B5CF6]/20 text-[#8B5CF6] border border-[#8B5CF6]/40">
                  ADMIN ONLY
                </span>
              </h2>
            ...
            {isEditingUpi && (
              <form onSubmit={handleSaveUpi} className="mt-3 pt-3 border-t border-[#2A313C] flex gap-2">
                <input
                  ...
                  className="flex-1 bg-[#171B22] border border-[#2A313C] rounded-xl px-3 py-1.5 text-xs font-mono text-[#F4F6F8] focus:border-[#8B5CF6] focus:outline-none"
                />
                <button
                  type="submit"
                  disabled={savingUpi}
