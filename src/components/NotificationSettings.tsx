    ...
    >
      <span
        className={`shrink-0 w-10 h-6 rounded-full p-0.5 flex items-center transition-colors ${
          checked ? 'bg-[var(--signal)] justify-end' : 'bg-[var(--rule)] justify-start'
        }`}
      >
        ...
        >
          ...
          {support === 'needs_permission' && (
            <button
              onClick={enable}
              disabled={busy}
              className="eb-btn-primary w-full py-3.5 rounded-xl text-sm font-mono font-black flex items-center justify-center gap-2"
            >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {prefs.dailySummaryAt && (
                        <button
                          ...
                          className="t-meta hover:eb-danger"
                        >
                          turn off
                        </button>
                      )}
