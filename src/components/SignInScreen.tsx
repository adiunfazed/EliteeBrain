    ...
    <div className="fixed inset-0 z-[95] flex items-center justify-center p-4 bg-[var(--ground)] overflow-y-auto overscroll-contain font-sans select-none animate-fadeIn">
      ...
      <div className="relative w-full max-w-lg bg-[var(--surface-sunk)] border border-[var(--rule)] rounded-xl p-6 sm:p-10 shadow-none my-auto text-center">
        ...
        {authMethod === 'google' ? (
          ...
          <form onSubmit={handleEmailSubmit} className="space-y-4 text-left mb-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--ground)] border border-[var(--rule)] focus:border-[var(--signal)] rounded-xl pl-10 pr-4 py-3 text-xs text-[var(--ink)] placeholder-[var(--ink-muted)]/50 focus:outline-none transition-colors"
                  />
                </div>
              </div>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-[var(--signal)] hover:bg-[var(--signal)]/90 text-white font-bold text-xs uppercase tracking-wider cursor-pointer shadow-lg transition-all active:scale-95 disabled:opacity-50 mt-2"
            >
              {loading ? (
                <>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center t-meta uppercase">
