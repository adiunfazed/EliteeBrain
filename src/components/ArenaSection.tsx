      ...
      <div className="eb-card p-4">
        <div className="flex items-center justify-between gap-2">
          <span className="eb-label flex items-center gap-1.5">
            <Trophy className="w-3 h-3 shrink-0 text-[#FFB020]" />
            Arena
          </span>
          <button
            onClick={onExpand}
        ...
        <div className="eb-card p-4">
          ...
          {nextTarget ? (
            ...
            <div className="flex items-center gap-2 mt-2">
              <Crown className="w-4 h-4 shrink-0 text-[#FFB020]" />
              ...
              {page?.entries.map((e, i) => {
                ...
                return (
                  <motion.div
                    ...
                    className={`eb-card-tap eb-shine relative overflow-hidden rounded-2xl border p-3 flex items-start gap-3 ${
                      isYou
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1">
                      {/* Two lines rather than one: the name gets the full
                          width and wraps instead of being cut off. */}
                      <span className="eb-heading text-sm block leading-tight break-words">
                        {e.displayName}
                        {isYou && (
                          <span className="text-[11px] font-mono font-bold text-[var(--signal-ink)] ml-1.5">
                            — YOU
                          </span>
                        )}
                      </span>
                      ...
                      <span className="flex items-center gap-1.5 mt-1 flex-wrap">
                        ...
                        {e.isPro && (
                          <span
                            title="Pro member"
                            className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-[#FFB020]/15 border border-[#FFB020]/40"
                          >
                            <Crown className="w-2.5 h-2.5 shrink-0 text-[#FFB020]" />
