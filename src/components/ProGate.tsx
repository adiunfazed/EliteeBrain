...
export const ProGate: React.FC<Props> = ({ profile, feature, blurb, onOpenPro, children }) => {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onOpenPro}
        className="eb-lift eb-marquee mt-5 px-5 py-3 rounded-xl bg-emerald-500 hover:brightness-110 text-slate-950 text-xs font-mono font-black inline-flex items-center gap-2"
      >
