      ...
      return (
        <div className="min-h-screen bg-[#0B0E14] text-[var(--ink)] flex items-center justify-center p-4 font-sans select-none">
          <div className="max-w-md w-full bg-[var(--surface)] border border-[var(--rule)] rounded-xl p-6 sm:p-8 shadow-none space-y-6 text-center relative overflow-hidden">
            ...
            {this.state.error && (
              <div className="bg-[#0B0E14] border border-[var(--rule)] rounded-xl p-3 text-left overflow-x-auto max-h-32 t-meta text-red-300">
            ...
            <div className="grid grid-cols-1 gap-3 pt-2">
              <button
                ...
                className="w-full h-11 bg-[var(--signal)] hover:bg-[#4B5ACD] text-white font-mono text-xs font-bold rounded-xl flex items-center justify-center gap-2 transition-all shadow-lg active:scale-95 cursor-pointer"
              >
