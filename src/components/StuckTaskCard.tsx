      ...
      {!suggestion ? (
        ...
        <AnimatePresence>
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-3">
            <p className="text-xs font-black font-mono text-[var(--signal-ink)]">{suggestion.headline}</p>
            ...
            <div className="flex items-center gap-2 mt-3 flex-wrap">
              {suggestion.minutes > 0 && onStartFocus && (
                <button
                  ...
                  className="eb-lift px-4 py-2.5 rounded-xl bg-[var(--signal)] hover:brightness-110 text-white text-xs font-mono font-black flex items-center gap-1.5"
                >
              ...
              <button
                ...
                className="eb-press px-3 py-2.5 t-meta hover:text-[var(--ink-muted)]"
              >
                Back
              </button>
            </div>
