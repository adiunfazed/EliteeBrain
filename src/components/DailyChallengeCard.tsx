      ...
      {completed ? (
        ...
        <>
          ...
          <motion.button
            ...
            className="eb-lift mt-4 w-full py-3 rounded-xl bg-[var(--signal)] hover:bg-[#7C3AED] text-white text-sm font-mono font-black flex items-center justify-center gap-2"
          >
