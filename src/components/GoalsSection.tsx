        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              aria-label="Add goal"
              className="eb-lift eb-glow-brand eb-shine shrink-0 w-11 h-11 rounded-xl bg-[#8B5CF6] hover:bg-[#7C3AED] disabled:opacity-40 text-white flex items-center justify-center"
            >
