          ...
          <div className="bg-[#181E2A] border border-[#2D3748] rounded-xl p-3.5 sm:p-4 mb-4 shrink-0 relative overflow-hidden">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 mb-2.5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="t-meta uppercase tracking-wider eb-warn font-bold">
                    Reward Tier Status
                  </div>
                    ...
                    <div className="flex items-start justify-between gap-3 mb-2.5">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <span className="inline-block t-meta eb-danger font-bold uppercase tracking-wider mt-0.5">
                            {badge.category}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col items-end gap-1 shrink-0">
                        <span
                          className={`px-2 py-0.5 border t-meta font-black rounded-md ${
                            isUnlocked
                        ...
                        {isUnlocked ? (
                          <span className="t-meta eb-done flex items-center gap-0.5 font-extrabold">
                            <CheckCircle2 className="w-3.5 h-3.5 shrink-0" /> Unlocked
                          </span>
                        ) : (
                          <span className="t-meta text-slate-400 font-extrabold">Locked</span>
                        )}
                      </div>
                    </div>
