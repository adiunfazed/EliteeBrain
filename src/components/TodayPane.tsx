      ...
      >
        <AnimatePresence>
          {(done || partial) && (
            ...
            >
              {done ? <Check className="w-3.5 h-3.5 shrink-0 stroke-[3]" /> : <MinusCircle className="w-3.5 h-3.5 shrink-0" />}
            </motion.span>
          )}
        </AnimatePresence>
      </span>
        ...
        <div className="text-center py-12 px-6 border border-dashed border-[var(--rule)] rounded-2xl">
          ...
          <div className="flex items-center gap-2 justify-center mt-4 flex-wrap">
            <button
              ...
              className="eb-btn-primary px-4 py-2.5 rounded-xl text-xs font-mono font-black"
            >
              Build my routine
            </button>
            <button
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-0.5 flex-wrap">
                    ...
                    {block.goalId && goalTitle(block.goalId) && (
                      <span className="t-meta text-[var(--signal-ink)] flex items-center gap-1 truncate">
                ...
                >
                  <div className="flex items-start justify-between gap-2 relative">
                    ...
                    {stats.currentStreak > 1 && (
                      <span className="t-meta flex items-center gap-0.5 opacity-80">
      ...
      {topTasks.length > 0 && (
        <div>
          <div className="flex items-center justify-between gap-2 mb-2">
            ...
            <button
              onClick={() => onGo('tasks')}
              className="eb-press t-meta text-[var(--signal-ink)] flex items-center gap-1"
            >
              All tasks
