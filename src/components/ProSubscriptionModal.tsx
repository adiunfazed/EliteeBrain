    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="relative w-full max-w-xl bg-slate-900 border border-amber-500/40 rounded-2xl p-5 md:p-7 shadow-none shadow-amber-500/10 font-sans my-auto text-slate-100"
        >
          {/* Close Button */}
          <motion.button
        ...
        {profile.isProUser && (
          <div className="mt-3.5 p-4 rounded-2xl bg-indigo-950/70 border border-indigo-500/50 shadow-inner space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="t-meta eb-done px-2.5 py-0.5 bg-emerald-950/80 border border-emerald-500/40 rounded-full flex items-center gap-1 whitespace-nowrap">
                <Zap className="w-3.5 h-3.5 shrink-0 eb-done" /> ACTIVE
              </span>
            </div>
            ...
            {profile.proAmountPaid && (
              <div className="t-meta text-slate-400 flex items-center justify-between px-1">
        ...
        {ent.status === 'free' && (
          <motion.button
            ...
            disabled={loading}
            className="eb-marquee w-full mt-4 p-4 rounded-2xl bg-[#00C97A] hover:brightness-110 disabled:opacity-50 text-[#04231A] text-left"
          >
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 mb-4 text-center space-y-3 shadow-inner">
          ...
          <div className="max-w-md mx-auto">
            ...
            <p className="text-[10px] font-sans text-slate-400 mt-1.5 flex items-center justify-center gap-1.5">
              <Shield className="w-3.5 h-3.5 shrink-0 eb-done" />
          ...
          <div className="pt-2 border-t border-slate-800/80">
            ...
            >
              ...
              />
              <div className="absolute -bottom-2.5 left-1/2 transform -translate-x-1/2 bg-amber-500 text-slate-950 t-meta font-black px-3 py-0.5 rounded-full shadow-md whitespace-nowrap">
        ...
        {successMsg ? (
          ...
          <motion.button
            ...
            className="w-full py-4 bg-[#25D366] hover:brightness-110 text-[#04231A] font-bold font-mono text-sm uppercase tracking-wider rounded-2xl flex items-center justify-center gap-2 cursor-pointer select-none touch-manipulation disabled:opacity-50"
          >
        ...
        <p className="t-meta text-slate-500 text-center mt-3">
