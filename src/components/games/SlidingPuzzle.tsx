    ...
    <div className="flex flex-col items-center max-w-xl mx-auto w-full">
      ...
      <div className="w-full flex justify-between items-center mb-6 gap-2 flex-wrap">
        ...
        <div className="flex gap-2">
          ...
          >
            <ImageIcon className="w-3.5 h-3.5 shrink-0" /> New Image
          </button>
          <button
          ...
          <button
            ...
            className="eb-press flex items-center gap-2 px-3 py-2 bg-emerald-500/12 border border-emerald-500/35 eb-done rounded-xl hover:bg-emerald-500/20 disabled:opacity-40 text-xs font-bold"
          >
      ...
      <div className="w-full max-w-full max-w-[500px] aspect-square bg-[var(--surface)] border border-[var(--rule)] rounded-xl p-2 relative shadow-none">
