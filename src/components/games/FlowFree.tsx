        ...
        <AnimatePresence>
          {isWon && (
            ...
            >
              ...
              <button
                onClick={() => setSeed(Math.random())}
                className="px-8 py-4 bg-white text-slate-900 font-bold rounded-xl flex items-center gap-2 hover:bg-slate-200 transition-colors shadow-none shadow-white/10"
              >
