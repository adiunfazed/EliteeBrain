      ...
      <div className="fixed inset-0 z-[60] bg-[#0B0D12] flex flex-col">
        <div className="flex items-center justify-between gap-2 p-3 shrink-0">
          ...
          <button
            ...
            className="eb-btn-ghost px-3 py-2 t-meta flex items-center gap-1.5 shrink-0"
          >
        ...
        <div className="flex-1 min-w-0 overflow-auto overscroll-contain touch-pan-y p-2 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
          {children}
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        <button
          onClick={onExit}
          className="eb-btn-ghost px-3 py-2 t-meta flex items-center gap-1.5"
        >
        ...
        <button
          ...
          className="eb-btn-primary px-3.5 py-2 t-meta flex items-center gap-1.5"
        >
