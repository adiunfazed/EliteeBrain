      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-rule mb-4">
        ...
        <div className="flex items-center gap-3 t-meta text-ink-muted">
          <div className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 shrink-0 bg-emerald-500 rounded-full inline-block" />
            <span>COMPLETED</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 shrink-0 bg-signal rounded-full inline-block animate-pulse" />
            <span>CURRENT DAY</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-2.5 h-2.5 shrink-0 bg-surface-sunk border border-rule rounded-full inline-block" />
