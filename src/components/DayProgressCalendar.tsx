  ...
  return (
    <div className={`bg-surface border border-rule rounded-2xl p-4 md:p-6 shadow-md ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-rule mb-4">
        ...
        {/* Legend */}
        <div className="flex items-center gap-3 t-meta text-ink-muted">
          <div className="flex items-center gap-1.5">
            <span className="w-3.5 h-3.5 shrink-0 bg-emerald-500 rounded-full inline-block" />
            <span>COMPLETED</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-3.5 h-3.5 shrink-0 bg-signal rounded-full inline-block animate-pulse" />
            <span>CURRENT DAY</span>
          </div>
          <div className="flex items-center gap-1.5">
            <span className="w-3.5 h-3.5 shrink-0 bg-surface-sunk border border-rule rounded-full inline-block" />
      ...
      <p className="t-meta text-ink-muted text-center mt-3">
        ...
        <div className="fixed inset-0 z-[92] flex items-center justify-center p-4 bg-ink/40 backdrop-blur-xs animate-fadeIn">
          <div className="relative w-full max-w-md bg-surface border border-rule rounded-2xl p-6 shadow-none font-sans">
            ...
            <div className="flex items-center gap-2 mb-1">
              <Calendar className="w-4 h-4 shrink-0 text-signal" />
            ...
            <div className="space-y-2 mb-5">
              <span className="block t-meta uppercase text-ink-muted">
