    ...
    <div className="fixed inset-0 z-[90] bg-black/75 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      ...
      >
        ...
        <div className="flex items-center gap-2.5 mt-6">
          <button onClick={onClose} className="btn-quiet flex-1 min-w-0">
            Keep my account
          </button>
          <button
            onClick={remove}
            disabled={!canDelete}
            className="flex-1 min-w-0 min-h-[48px] rounded-xl font-semibold text-white transition-opacity disabled:opacity-35"
