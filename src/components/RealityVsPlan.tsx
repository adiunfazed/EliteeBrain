  ...
  return (
    <div className="eb-panel p-4 sm:p-5">
      <span className="eb-label flex items-center gap-1.5">
        <Scale className="w-3.5 h-3.5 shrink-0 text-[var(--signal-ink)]" />
      ...
      {signals.length > 0 && (
        <div className="mt-4 pt-3.5 border-t border-[var(--rule)] space-y-2">
          <span className="eb-label flex items-center gap-1.5">
            <Lightbulb className="w-3.5 h-3.5 shrink-0 eb-warn" />
            ...
            <div key={s.key} className="flex items-start justify-between gap-3">
              ...
              {onGo && (
                <button
                  ...
                  className="eb-press shrink-0 t-meta text-[var(--signal-ink)] flex items-center gap-1"
                >
                  Open
