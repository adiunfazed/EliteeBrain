              ...
              {todayTasks.map((t) => (
                <button
                  ...
                  className={`eb-press eb-shine w-full text-left px-3 py-2.5 rounded-xl border text-sm flex items-center gap-2.5 ${
                    selectedTaskId === t.id
                      ? 'bg-[#5C6CF2]/15 border-[#5C6CF2]/50 text-[#F4F6F8] shadow-[0_0_18px_-6px_rgba(92,108,242,0.7)]'
            ...
            {FOCUS_PRESETS.map((m) => (
              <button
                ...
                className={`eb-press eb-shine px-4 py-2 rounded-xl border text-xs font-mono font-bold ${
                  minutes === m
                    ? 'text-[#818CF8] bg-[#5C6CF2]/15 border-[#5C6CF2]/40 shadow-[0_0_18px_-6px_rgba(92,108,242,0.7)]'
