...
import { prefetchCareerStats } from './lib/careerStats';
  ...
  useEffect(() => {
    ...
    const unsubscribeAuth = onAuthStateChanged(auth, async (user) => {
      ...
      if (user) {
        ...
        // Warm the rank figures during the splash rather than after Home
        // renders. On a cold instance this request is the slowest thing in
        // the startup path, so starting it early is most of the fix.
        prefetchCareerStats(user.uid).catch(() => {});
